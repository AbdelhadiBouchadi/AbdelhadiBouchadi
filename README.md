<div align="center">
  <h1>Hi, I'm Abdelhadi Bouchadi 👋</h1>
  <h3>Full-Stack Software Engineer | Computer Engineering Student</h3>
  <p>Architecting high-performance web applications, scalable database schemas, and machine learning pipelines.</p>
</div>

---

## 🚀 About My Engineering Focus

I specialize in bridging the gap between complex backend logic and clean, functional user interfaces. As a Computer Engineering student (focusing heavily on Automata Theory, Computer Networks, and Applied ML), I don't just use frameworks—I understand the underlying computer science fundamentals that make them run efficiently.

- 🏢 **Currently Building:** Enterprise-grade SaaS platforms, private hospital management systems, and real-time AI infrastructure.
- ⚙️ **Core Philosophy:** End-to-end type safety, highly relational database architecture, and asynchronous background processing.
- 🎯 **Market Pipeline:** Operating as an independent developer deploying production-ready code for real-world clients.
...
Next.js | React | TypeScript | Tailwind CSS | GSAP | Framer Motion | Three.js (WebGL)

**Backend & State Management:**
Node.js | tRPC | TanStack React Query | Next-Auth v5 | Inngest | WebRTC (Stream API)

**Database & ORMs:**
PostgreSQL | MongoDB | Prisma | Drizzle ORM | Neon Serverless

**Data Science & Machine Learning:**
Python | TensorFlow / Keras | XGBoost | Scikit-Learn | Pandas | OpenAI API
...
<div align="center">
  <p><b>Let's build something complex.</b></p>
</div>
